            ...
            <form action="#">
                <div class="flex justify-center content-center">
                    <div>
                        ...
                        <div><input class="pr-20" id="hotel__name" type="text" placeholder="Отель"/></div>
                    </div>
                    <div>
                        <div><label for="entry__date">Дата заезда</label></div>
                        <div><input class="pr-20" id="entry__date" type="date"/></div>
                    </div>
                    <div>
                        <div><label for="leave__date">Дата отъезда</label></div>
                        <div><input class="pr-20" id="leave__date" type="date"/></div>
                    </div>
                    <div>
                        <div><label for="visitors__number">Количество человек</label></div>
                        <div><input class="pr-20" id="visitors__number" type="number" placeholder="Количество человек"/></div>
                    </div>
                    <div class="pt-6">
